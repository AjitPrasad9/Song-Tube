...
async function getSongs(folder) {
  ...
  for (const song of songs) {
    songUL.innerHTML =
      songUL.innerHTML +
      `<li><img class="" width="34" src="img/music.svg" alt="musicIcon">
                          <div class="info">
                              <div class="mu"> ${song.replaceAll("%20", " ")}</div>
                          </div>
                          <div class="playnow">
                             
                              <img class="" src="img/play.svg" alt="playIcon">
                          </div> </li>
                          `;
...
async function main() {
  await getSongs("songs/1ArijitSingh");
